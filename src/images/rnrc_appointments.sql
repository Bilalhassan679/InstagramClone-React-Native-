...
--
-- Table structure for table `rnrc_appointments`
--

CREATE TABLE `rnrc_appointments` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `rnrc_appointments`
--
...
--
-- Indexes for table `rnrc_appointments`
--
ALTER TABLE `rnrc_appointments`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `rnrc_appointments`
--
ALTER TABLE `rnrc_appointments`
